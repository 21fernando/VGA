...
#
# Generated by Vivado on Sun Jul 17 20:29:42 -0400 2022
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/taf27/Documents/FPGA/VGA_FRAME_BUFFER/VGA_FRAME_BUFFER.cache/compile_simlib/activehdl"
  fi
